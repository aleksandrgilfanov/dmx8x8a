...
static void MX_TIM2_Init(void)
{
  ...
  htim2.Instance = TIM2;
  htim2.Init.Prescaler = CORE_PWM_TIMER_PRESCALER;
  htim2.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim2.Init.Period = CORE_PWM_TIMER_PERIOD;
...
static void MX_TIM3_Init(void)
{
  ...
  htim3.Instance = TIM3;
  htim3.Init.Prescaler = CORE_PWM_TIMER_PRESCALER;
  htim3.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim3.Init.Period = CORE_PWM_TIMER_PERIOD;
...
static void MX_USART1_UART_Init(void)
{
  ...
  /* Enable error (framing error etc) interrupt */
